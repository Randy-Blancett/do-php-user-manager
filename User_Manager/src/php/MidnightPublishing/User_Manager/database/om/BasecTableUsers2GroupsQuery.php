...
abstract class BasecTableUsers2GroupsQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'user_manager', $modelName = 'MidnightPublishing\\User_Manager\\database\\cTableUsers2Groups', $modelAlias = null)
    {
     ...
     * @param   cTableUsers2GroupsQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   cTableUsers2Groups|cTableUsers2Groups[]|mixed the result, formatted by the current formatter
     */
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            cTableUsers2GroupsPeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|cTableUsers2Groups[]|mixed the list of results, formatted by the current formatter
     */
