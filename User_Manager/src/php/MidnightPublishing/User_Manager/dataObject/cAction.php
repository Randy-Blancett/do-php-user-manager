...
class cAction extends cTableActions
{
	...
	const C_STR_USER_MANAGER_CONFIG_VIEW			 = "B59074CF-375F-4E34-B232-A2606A03553E";
	const C_STR_USER_MANAGER_CONFIG_EDIT			 = "FEBAA4AD-57DC-4E47-AA84-57B88FEBE859";
	...
	public static function addDefault()
	{
		...
		$obj_Action = new cAction();
		$obj_Action->setId(self::C_STR_USER_MANAGER_CONFIG_VIEW);
		$obj_Action->setName("View Config Details");
		$obj_Action->setApplication(cApplication::C_STR_ID_USER_MANAGER);
		$obj_Action->setComment("Allows users to view config Details");
		self::addAction($obj_Action);

		$obj_Action = new cAction();
		$obj_Action->setId(self::C_STR_USER_MANAGER_CONFIG_EDIT);
		$obj_Action->setName("Edit Config Details");
		$obj_Action->setApplication(cApplication::C_STR_ID_USER_MANAGER);
		$obj_Action->setComment("Allows User to edit configuration.");
		self::addAction($obj_Action);
	}
