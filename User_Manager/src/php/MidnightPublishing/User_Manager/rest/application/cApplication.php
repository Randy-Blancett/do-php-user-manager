...
class cApplication extends \Tonic\Resource {
	...
	public function getSingleJson($str_ID)
	{
		...
		if(!$obj_User->checkPermissions(cAction::C_STR_USER_MANAGER_APPLICATION_VIEW))
		{
	...
	public function deleteJson($str_ID = null)
	{
		...
		if(!$obj_User->checkPermissions(cAction::C_STR_USER_MANAGER_APPLICATION_DELETE))
		{
			$this->m_obj_Response->setSuccess(false);
			$this->m_obj_Response->setCode(\Tonic\Response::FORBIDDEN);
		}
	...
	public function putJson($str_ID = null)
	{
		...
		if(!$obj_User->checkPermissions(cAction::C_STR_USER_MANAGER_APPLICATION_EDIT))
		{
			$this->m_obj_Response->setSuccess(false);
			$this->m_obj_Response->setCode(\Tonic\Response::FORBIDDEN);
		}
	...
	public function postJson() {
		...
		if(!$obj_User->checkPermissions(cAction::C_STR_USER_MANAGER_APPLICATION_ADD))
		{
			$this->m_obj_Response->setSuccess(false);
			$this->m_obj_Response->setCode(\Tonic\Response::FORBIDDEN);
		}
