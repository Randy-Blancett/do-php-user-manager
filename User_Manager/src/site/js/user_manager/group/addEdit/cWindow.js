Ext.define('darkowl.userManager.group.addEdit.cWindow', {
	extend : 'darkowl.desktop.cDesktopWindow',
	title : "Add/Edit Group",
	requires : [ 'darkowl.userManager.group.addEdit.cTopForm' ],
	...
	initComponent : function() {
		...
		this.m_obj_Form = Ext
				.create('darkowl.userManager.group.addEdit.cTopForm');
