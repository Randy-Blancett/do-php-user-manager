Ext
        .define(
                'darkowl.userManager.group.view.cGrid',
                {
                    ...
                    {
	                    this.store = Ext
	                            .create('darkowl.userManager.store.cGroupList');
	                    ...
	                    userManager.MsgBus
	                            .on(
	                                    userManager.MsgBus.self.C_STR_EVENT_GROUP_ADDED,
                    ...
                    {
	                    this.ownerCt
	                            .fireEvent(darkowl.userManager.group.view.cWindow.C_STR_EVENT_EDIT);
                    },
