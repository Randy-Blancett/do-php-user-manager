...
abstract class BasecTableUsersPeer {
	...
	const CLASS_DEFAULT = 'database.cTableUsers';
	 ...
	 *
	 * @param      cTableUsers $value A cTableUsers object.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = cTableUsersPeer::getOMClass(false);
	...
	{
		return $withPrefix ? cTableUsersPeer::CLASS_DEFAULT : cTableUsersPeer::OM_CLASS;
	}
